        ...
        <div className="max-w-[1440px] bg-[#0dae99] flex flex-col">
            <div
                ...
                <div className="w-[100%] lg:w-[50%]">
                    <h1 className="text-[1.5rem] md:text-[2.8rem] font-extrabold text-[#393535] text-center lg:text-start">Specialty For
                        Every
                        Occasion</h1>
                    <p className="text-[1.3rem] md:text-[1.5rem] font-normal text-[#fff] text-justify">Sweets have been the part of every
            ...
            <div
                ...
                <div className="w-[100%] lg:w-[50%]">
                    <h1 className="text-[1.5rem] md:text-[2.8rem] font-extrabold text-[#393535] text-center lg:text-end">The Taste of
                        Fresh Snacks</h1>
                    <p className="text-[1.3rem] md:text-[1.5rem] font-normal text-[#fff] text-justify">Any occasion or
                        your evening
                        tea
                        time, enjoy the
                        fresh taste
